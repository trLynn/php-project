...
<body>
    <div class="container">
        <div style="float: right">
            ...
            <a href="_actions/logout.php" class="text_danger">Logout</a>
        </div>
                        ...
                        <?php if($auth->value > 1): ?>
                            <div class="btn-group dropdown">
                                ...
                                <?php if($user->id !== $auth->id): ?>
                                    <a href="_actions/delete.php?=<?= $user->id ?>" class="btn btn-sm btn-outline-danger" onClick="return confirm('Are you sure?')">Delete</a>
                                <?php endif ?>
                            </div>
                        <?php else: ?>
                            ###
